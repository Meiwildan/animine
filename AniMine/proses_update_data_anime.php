...
body{
    ...
    background-size: cover;
        ...
        <h1 style="text-align: center;">Update List Anime</h1>
        <div class="center">
<?php
    session_start();
    ...
    $getData = $conn->query("SELECT * FROM anime WHERE id_anime = ".$id);
...
<form action="do_simpan.php" method="post" enctype="multipart/form-data">
    ...
    <table>
        <tr>
            <td>Judul Anime</td>
            <td>:</td>
            <td><input type="text" name="judul_anime" value="<?=$getData["judul_anime"]?>"></td>
         </tr>
        <tr>
            <td>Pengarang</td>
            <td>:</td>
             <td><input type="text" name="pengarang" value="<?=$getData["pengarang"]?>"></td>
          </tr>
         <tr>
             <td>Studio</td>
                <td>:</td>
                <td><input type="text" name="studio" value="<?=$getData["studio"]?>"></td>
            </tr>
            <tr>
             <td>Cover Anime</td>
                <td>:</td>
